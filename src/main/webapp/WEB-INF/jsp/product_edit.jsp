...
<div style="padding: 10px 10px 10px 10px">
		...
		<table cellpadding="5">
			<tr>
				...
				<td><input class="easyui-textbox" type="text"
					name="productName" data-options="required:true"></input></td>
			</tr>
			<tr>
				<td>产品种类:</td>
				<td><input class="easyui-textbox" type="text"
					name="productType" data-options="required:true"></input></td>
			</tr>
			<tr>
				<td>单价:</td>
				<td><input class="easyui-numberbox" type="text"
					name="unitPrice"
					data-options="min:0,max:99999999,precision:2,required:true" /></td>
			</tr>
			<tr>
				<td>单位:</td>
			...
			<tr>
				...
				<td><a href="javascript:void(0)"
					class="easyui-linkbutton productPicFileUpload">上传图片</a> <input
					type="hidden" id="productImage" name="image" /></td>
			</tr>
			<tr>
				<td>产品介绍:</td>
				<td><textarea
	...
	<div style="padding: 5px">
		<a href="javascript:void(0)" class="easyui-linkbutton"
			onclick="submitProductEditForm()">提交</a>
	</div>
</div>
	...
	function submitProductEditForm() {
		$.get("product/edit_judge", '', function(data) {
			if (data.msg != null) {
				...
				$.post("product/update_all", $("#productEditForm").serialize(),
						function(data) {
							if (data.status == 200) {
								$.messager.alert('提示', '修改产品成功!', 'info',
										function() {
